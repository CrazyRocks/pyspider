#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Created on 2016-12-12 18:38:04
# Project: zhangjie
...
class Handler(BaseHandler):
    ...
    def detail_page(self, response):
        return {
            "url": response.url,
            "title": response.doc('div#main div.book h1').text(),
            "description": response.doc('div#main div.book div.description p').text(),
            "chapter": response.doc('div#main div.book dl').text(),
        }
